...
def inicia_servidor(IP,PORTA,nome_usuario):
    ...
    #print("Servidor do peer 3 iniciado, aguardando conexões...")
...
def main():
    ...
    Thread(target=inicia_servidor, args=(IP_LOCAL, PORTA_LOCAL,"Nick"), daemon=True).start()

    print("Chat iniciado, aguardando mensagens...\n\n")

    while True:
        mensagem = input("")
        cliente(IP_DESTINO,PORTA_DESTINO,"Nick",mensagem)
